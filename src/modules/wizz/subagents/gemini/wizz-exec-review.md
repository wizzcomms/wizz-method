...
description: Revisor do Wizz Method, herda o modelo da sessão por default. Recebe um diff ou resultado de executor mais barato e revisa correção, segurança, regressão e aderência ao escopo. Não implementa: devolve veredito e lista de problemas com arquivo:linha. "review" aqui é o DEGRAU de revisão da escada Wizz.
kind: local
---
