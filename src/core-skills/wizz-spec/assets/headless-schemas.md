...
```json
{
  "status": "complete",
  "files": [
    "_wizz-output/specs/spec-quarter-drop/SPEC.md",
    "_wizz-output/specs/spec-quarter-drop/glossary.md",
    "_wizz-output/specs/spec-quarter-drop/.memlog.md"
  ]
}
```
...
```json
{
  ...
  "reason": "Input was a one-line idea with no surrounding context; too thin to distill. Suggest wizz-prd to draw the vision out first."
}
```
