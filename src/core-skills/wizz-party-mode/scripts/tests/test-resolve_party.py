...
class TestBuildCollective(unittest.TestCase):
    def test_installed_agents_indexed_by_code_alias_and_name(self):
        ...
        self.assertEqual(set(col), {"wizz-agent-analyst", "wizz-agent-pm"})
        self.assertEqual(idx["analyst"], "wizz-agent-analyst")      # alias
        self.assertEqual(idx["mary"], "wizz-agent-analyst")         # name (ci)
        self.assertEqual(idx["wizz-agent-pm"], "wizz-agent-pm")     # full code
        self.assertEqual(col["wizz-agent-analyst"]["source"], "installed")
    ...
    def test_custom_overrides_installed_by_alias(self):
        ...
        self.assertEqual(col["wizz-agent-analyst"]["source"], "custom")
        self.assertEqual(col["wizz-agent-analyst"]["name"], "Mary-Custom")
...
class TestResolveMembers(unittest.TestCase):
    ...
    def test_resolves_in_listed_order_and_flags_unknowns(self):
        ...
        self.assertEqual([m["code"] for m in resolved], ["morpheus", "wizz-agent-analyst"])
...
class TestInstalledCodesIsDefaultRoom(unittest.TestCase):
    ...
    def test_pure_custom_excluded_override_kept_in_default_room(self):
        ...
        self.assertEqual(default_room, ["wizz-agent-analyst", "wizz-agent-pm"])
