...
- **BE CONCISE.** Minimize prose. Use one-line status updates (e.g. "✅ Task 1 done"). No preambles, no re-stating intent, no summaries between tasks. Show code, not explanations. Only elaborate when a HALT or a user question requires it.
