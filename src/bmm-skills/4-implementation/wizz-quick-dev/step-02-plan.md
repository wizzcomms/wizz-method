...
Before approving, you can open the spec file in an editor or ask me questions and tell me what to change. You can also use `wizz-advanced-elicitation`, `wizz-party-mode`, or `wizz-code-review` skills, ideally in another session to avoid context bloat.
