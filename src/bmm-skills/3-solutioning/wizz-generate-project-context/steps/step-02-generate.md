...
- When 'A' selected: Invoke the `wizz-advanced-elicitation` skill
- When 'P' selected: Invoke the `wizz-party-mode` skill
...
- Invoke the `wizz-advanced-elicitation` skill with current category rules
...
- Invoke the `wizz-party-mode` skill with category rules context
