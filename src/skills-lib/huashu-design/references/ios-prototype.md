...
> 从 SKILL.md「App / iOS 原型专属守则」下沉的完整版（2026-07 progressive disclosure 瘦身）。触发：「app 原型」「iOS mockup」「移动应用」「做个 app」——下面 6 条**覆盖**通用 placeholder 原则，app 原型是 demo 现场，静态摆拍和米白占位卡没有说服力。SKILL.md 留了触发词摘要，这里是完整 6 条规则。
