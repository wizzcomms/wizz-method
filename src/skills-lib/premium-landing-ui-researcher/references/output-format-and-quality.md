...
Esta skill é um agregador de fontes maduras. Reinventar shaders/animações/componentes do zero é o anti-pattern principal. Releia o `<EXTREMELY-IMPORTANT>` no topo de references/source-first-protocol.md se houver qualquer dúvida.
