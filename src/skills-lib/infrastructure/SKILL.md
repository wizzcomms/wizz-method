---
name: infrastructure
description: Escalabilidade de infraestrutura — auto-scaling, Kubernetes HPA/VPA, CDN, SLOs, load testing. Use quando o pedido envolver escala de servidores, Kubernetes, CDN, monitoramento de capacidade.
---
