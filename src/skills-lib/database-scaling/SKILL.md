...
description: Escalar banco de dados — sharding, réplicas de leitura, connection pooling, índices, N+1, particionamento. Use quando o pedido envolver banco lento, performance de queries, escala de dados.
---
